const translations = {
    en: {
        ...
        privacy_text: "Personal data is processed only to handle community interaction and business requests. Streaming platforms (Twitch, YouTube, TikTok etc.) have separate privacy policies."
    },
    de: {
        page_title: "Nhywyll - VTuber Streamer & Content Creator",
        ...
        imprint_company: "Firma: Nhywyll",
        imprint_address: "Adresse: [Straßenname], [Stadt], [Land]",
        imprint_contact: "Kontakt: nhywyll@outlook.com",
        privacy_section: "Datenschutz",
        privacy_text: "Persönliche Daten werden nur zur Abwicklung von Community-Interaktionen und Geschäftsanfragen verarbeitet. Streaming-Plattformen (Twitch, YouTube, Tiktok usw.) haben separate Datenschutzrichtlinien."
    }
};
...
function createCookieBanner() {
    ...
    const text = isDe ? 'Diese Website verwendet Cookies für Analysen.' : 'This site uses cookies for analytics.';
    const btnText = isDe ? 'Akzeptieren' : 'Accept';

    const bannerHTML = `
    <div id="cookie-banner" class="cookie-banner">
        <p>${text} <button id="accept-cookies">${btnText}</button></p>
    </div>
    `;
